                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <button
                                onclick="confirm('Are you sure you wish to make the quotation')||event.stopImmediatePropagation()"
                                wire:click='makeQuotation' class="btn btn-dark text-inv-primary w-100">Make Quotation</button>
