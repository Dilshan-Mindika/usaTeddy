...
<head>
    ...
    <title>{{ config('app.name', 'SeamSync') }}</title>
...
<body class="layout-fixed sidebar-expand-lg  bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <aside class="app-sidebar bg-inv-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand text-inv-primary"> <!--begin::Brand Link-->
    ...
    <script src="{{ asset('admin-lte/js/adminlte.js') }}"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    <script>
